...
// 0 --------------------------------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Passo 1: Chiudi P chiude F",
    tasks: [
        {
            "id": "616",
            "name": "test",
            ...
            "endDate": "20/09/2016",
            "lastModified": 1474028638447,
            "lastModifier": "System Manager",
            "totalIssues": 0,
            "openIssues": 0,
            "budget": 0,
            "totalCosts": 0,
    ...
    prepareTest: function () {
        ...
        ge.tasks[1].rowElement.find(".taskStatus").click().oneTime(100, "setStat", function () {
            $(this).next().find("[status=STATUS_DONE]").click()
        });
    },
    assertOk: function () {
...
// 1 --------------------------------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Passo 2: Provo ad aprire P, non ci riesco",
    prepareTest: function () {
        //apro il selettore stati e chiudo il task
        ge.tasks[2].rowElement.find(".taskStatus").click().oneTime(100, "setStat", function () {
            $(this).next().find("[status=STATUS_ACTIVE]").click()
        });
    },
    assertOk: function () {
        return ge.tasks[1].status == "STATUS_DONE" && ge.tasks[2].status == "STATUS_DONE";
...
// 2 --------------------------------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Passo 3: Fallisce P fallisce F",
    prepareTest: function () {
        //apro il selettore stati e chiudo il task
        ge.tasks[1].rowElement.find(".taskStatus").click().oneTime(100, "setStat", function () {
            $(this).next().find("[status=STATUS_FAILED]").click()
        });
    },
    assertOk: function () {
...
// 3 --------------------------------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Passo 4: Apro P, F resta fallito",
    prepareTest: function () {
        //apro il selettore stati e chiudo il task
        ge.tasks[1].rowElement.find(".taskStatus").click().oneTime(100, "setStat", function () {
            $(this).next().find("[status=STATUS_ACTIVE]").click()
...
// 4 ------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Indenta figlio sotto padre chiuso: chiude figlio",
    tasks: [
        {
            "id": "624",
            "name": "test",
...
//5 ------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Crea 2 dip da task aperto con lag diversi: C->waiting, c.start max lag ",
    tasks: [
        {
            "id": "624",
            "name": "test",
...
// 7 ------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Chiude A : mette B e C in stato aperto",
    tasks: [
        {
            "id": "624",
            "name": "test",
...
ganttTestUnits.push({
    ...
    prepareTest: function () {
        //apro il selettore stati e clicco su done
        ge.tasks[0].rowElement.find(".taskStatus").click().oneTime(100, "setStat", function () {
            $(this).next().find("[status=STATUS_ACTIVE]").click()
        });
    },
    assertOk: function () {
...
// 9 ------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Caso Cabassi passo 1: c dipende da a, c1 dipende da b1: si deve poter chiudere b1",
    tasks: [
        {
            "id": "624",
            "name": "test",
    ...
    prepareTest: function () {
        //apro il selettore stati e clicco su done
        ge.tasks[3].rowElement.find(".taskStatus").click().oneTime(100, "setStat", function () {
            $(this).next().find("[status=STATUS_DONE]").click()
        });
    },
    assertOk: function () {
...
// 12 ------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Test durate: indenta b(2gg) sotto a(1gg): root -> 3gg, a->2gg, c prende la stessa fine di b",
    tasks: [
        {
            "id": "624",
            "name": "test",
...
// 13 ------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Loop indentando b1 sotto b: candidato figlio con dip che coinvolgono il futuro padre. Deve rimuovere la dip da b1 ad a",
    tasks: [
        {
            "id": "745",
            "name": "test loop",
...
// 14 ------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Cambio le dipendenze di C mettendo lag -> A e B devono restare chiusi",
    tasks: [
        {
            "id": "844",
            "name": "altro test",
...
// 17 ------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "End is milestone: cambia la durata da 1 a 3 giorni: start deve andare indietro di 2 giorni, end non si deve muovere",
    tasks: [
        {
            "id": "624",
            "name": "test",
...
// 18 --------------------------------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Passo 1: Sospende P Sospende F",
    tasks: [
        {
            "id": "616",
            "name": "test",
...
// 19 --------------------------------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Sposto il padre di 1 gg. Passo 1 avanti: padre stessa durata, figlio 1 stessa data del padre ",
    tasks: [
        {
            "id": "tmp_1",
            "name": "p",
            ...
            "totalWorklog": 0,
            "totalEstimated": 0,
            "totalEstimatedFromIssues": 0,
            "totalIssues": 0,
            "openIssues": 0,
            "lastModified": 1512984195515,
            "lastModifier": "System Manager",
            "budget": 0,
            "totalCosts": 0
        },
...
// 20 --------------------------------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Sposto il padre di 1 gg. Passo 2 indietro: padre stessa durata, figlio 1 stessa data del padre ",
    prepareTest: function () {
...
// 21 --------------------------------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Always shrink flag ON: accorciando la durata di un figlio da 2 a 1 il padre deve passare da 4 a 3",
    tasks: [
        {
            "id": "tmp_1",
            "name": "p",
...
// 22 --------------------------------------------------------------------------------------------------------------
ganttTestUnits.push({
    name: "Always shrink flag OFF: accorciando la durata di un figlio da 2 a 1 il padre deve rimanere a 4",
    tasks: [
        {
            "id": "tmp_1",
            "name": "p",
