//TODO: Deprecate/Remove, maybe start with the discussion on https://stackoverflow.com/questions/7675526/is-livequery-deprecated as an example
//TODO: Check repo on https://github.com/brandonaaron/livequery
(function ($) {
    $.extend($.fn, {
    ...
    $.extend($.livequery, {
        ...
        pause: function () {
            ...
            if (id != undefined) $.livequery.queries[id].stop(); else $.each($.livequery.queries, function (id) {
